...
3. **Real headless browser via FlareSolverr** — for the cases the steps above can't reach (JS-computed PoW/fingerprint, in-page-fetch-only JSON endpoints, JA3-fingerprint blocking that the sidecar's Bun fetch can't disguise). See §5.
